    ...
    <>
      <header className="header">
        <nav className="nav bd_grid">
          ...
          <div className="nav_menu" id="nav_menu" ref={navref}>
            <ul className="nav_list">
              ...
              <li className="nav_items">
                <a href="#project" className="nav_link active">
                  Project
                </a>
              </li>
              <li className="nav_items">
          ...
          <div className="nav_toggle" id="nav_toggle" onClick={toggle}>
      ...
      <main className="main">
        <section className="home bd_grid" id="home">
          ...
          <div className="home_img" data-aos-delay="500">
            <svg
        ...
        <section className="about section" id="about">
          ...
          <div className="about_container bd_grid">
            <div className="about_img" data-aos-delay="50">
              <svg
            ...
            <div>
              <h2 className="about_subtitle" data-aos-delay="350">
                I'm Hariharan P
              </h2>
